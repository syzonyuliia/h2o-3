...
public class ModelMetricsBinomial extends ModelMetricsSupervised {
  ...
  public static class IndependentMetricBuilderBinomial extends IndependentMetricBuilderSupervised<IndependentMetricBuilderBinomial> { 
    protected double _logloss;
    protected AUC2.AUCBuilder _auc;
    ...
    public IndependentMetricBuilderBinomial(String[] domain, DistributionFamily distributionFamily) {
      ...
      @Override public void reduce( IndependentMetricBuilderBinomial mb ) {
        super.reduce(mb); // sumseq, count
        _logloss += mb._logloss;
        _auc.reduce(mb._auc);
      }
