...
public class ModelMetricsRegression extends ModelMetricsSupervised {
  ...
  public static class IndependentMetricBuilderRegression extends IndependentMetricBuilderSupervised<IndependentMetricBuilderRegression> {
    double _sumdeviance;
    Distribution _dist;
    double _abserror;
    double _rmslerror;
    ...
    @Override public void reduce( IndependentMetricBuilderRegression mb ) {
      super.reduce(mb);
      _sumdeviance += mb._sumdeviance;
      _abserror += mb._abserror;
      _rmslerror += mb._rmslerror;
